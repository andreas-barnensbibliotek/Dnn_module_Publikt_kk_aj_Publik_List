...
' are accessible to your module's controls (that inherity from Dnn_module_kk_aj_Publik_productlistModuleBase
' 
' </summary>

Public Class Dnn_module_kk_aj_Publik_productlistSettingsBase
